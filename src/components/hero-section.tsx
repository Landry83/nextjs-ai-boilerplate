                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Introducing AI Chat Integration</span>
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            <div className="flex items-center justify-center">
                                <div className="text-center">
                                    <div className="bg-blue-100 dark:bg-blue-900/20 rounded-lg p-3 mb-2">
                                        <Code2 className="h-6 w-6 text-blue-600 dark:text-blue-400 mx-auto" />
                                    </div>
                            ...
                            <div className="flex items-center justify-center">
                                <div className="text-center">
                                    <div className="bg-green-100 dark:bg-green-900/20 rounded-lg p-3 mb-2">
                                        <Database className="h-6 w-6 text-green-600 dark:text-green-400 mx-auto" />
                                    </div>
                            ...
                            <div className="flex items-center justify-center">
                                <div className="text-center">
                                    <div className="bg-purple-100 dark:bg-purple-900/20 rounded-lg p-3 mb-2">
                                        <Zap className="h-6 w-6 text-purple-600 dark:text-purple-400 mx-auto" />
                                    </div>
                            ...
                            <div className="flex items-center justify-center">
                                <div className="text-center">
                                    <div className="bg-pink-100 dark:bg-pink-900/20 rounded-lg p-3 mb-2">
                                        <Palette className="h-6 w-6 text-pink-600 dark:text-pink-400 mx-auto" />
                                    </div>
                                    <span className="text-xs font-medium text-muted-foreground">shadcn/ui</span>
                                </div>
                            </div>
                        </div>
                    </div>
